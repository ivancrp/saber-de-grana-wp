...
<form role="search" method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>">
    <label class="sr-only"><?php esc_html_e('Buscar por:', 'saberdegrana'); ?></label>
    <div class="relative">
