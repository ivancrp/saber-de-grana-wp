...
<div id="page" class="site min-h-screen bg-background">
    <header id="masthead" class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-primary">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <a href="<?php echo esc_url(home_url('/busca')); ?>" class="p-2 rounded-full">
                ...
                <div class="md:hidden flex items-center">
                    <button id="mobile-menu-toggle" class="p-2 text-white" aria-label="Open menu">
